...
class Client(models.Model):
    ...
    client_number = models.IntegerField(primary_key=True, blank=False, null=False)
...
class Item(models.Model):
    name = models.CharField(max_length=50)
    item_number = models.IntegerField(primary_key=True, blank=False, null=False)
...
class Employee(models.Model):
    emp_number = models.IntegerField(primary_key=True, blank=False, null=False)
    name = models.CharField(max_length=50)
    address = models.CharField(max_length=200)
    city = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
...
class Donor(models.Model):
    donor_number = models.IntegerField(primary_key=True, blank=False, null=False)
    name = models.CharField(max_length=50)
    address = models.CharField(max_length=200)
    city = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
